...
use Rogama\DemoBundle\Entity\Role;
use Rogama\DemoBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DemoBundle:Role')->findAll();
     ...
     * @Method("POST")
     * @Template("DemoBundle:Role:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DemoBundle:Role')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("DemoBundle:Role:edit.html.twig")
     */
